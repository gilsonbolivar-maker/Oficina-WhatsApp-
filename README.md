...
- Emojis funcionam: basta digitá-los pelo teclado. Quando a mensagem tem cor, a imagem sai como PNG colorido (mais pesado); sem cor, continua no PNG de 4 bits em escala de cinza.
